...
if model == 'FC':
  avg_data_path = f'/home/Daniel/DeepProject/dataset/cut_train_data_360_repr/'
else:  
  avg_data_path = f'/home/Daniel/DeepProject/dataset/cut_train_data_360_avg_repr_{model}/'
...
speaker_counter = 0
if model == 'FC':
  file_path = f'{rootDir}cut_train_data_360_repr'
else:
  file_path = f'{rootDir}cut_train_data_360_full_repr_{model}'
print(file_path)
try:  
