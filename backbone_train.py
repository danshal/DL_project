...
writer = SummaryWriter('/home/Daniel/DeepProject/back_bone_train_summary_events')
...
#   writer.close()
  ...
  on_top_net.load_state_dict(torch.load('/home/Daniel/DeepProject/checkpoint.pt'))
